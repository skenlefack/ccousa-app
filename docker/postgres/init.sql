...
-- Utilise pgcrypto pour générer un hash bcrypt valide
INSERT INTO users (identifier, email, password_hash, first_name, last_name, role_id, status, default_language_id, default_timezone_id)
SELECT
    'ADMIN001',
    'admin@ccousa-app.cm',
    ...
    (SELECT id FROM timezones WHERE code = 'Africa/Douala')
